  ...
  return (
    <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
      <div
        ...
        {/* Z-index allows image -> first inner div -> second inner div placement to create the shadow around phone and also changing the phone background */}
          ...
          <div className="w-full h-full flex justify-end items-center">
            <div className="w-full flex gap-6 items-center">
              ...
              <Button
                ...
                Continue <ArrowRight className="ml-1.5 h-4 w-4 inline" />
              </Button>
            </div>
          </div>
        </div>
